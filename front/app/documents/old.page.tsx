          ...
          {selectedFolder && (
            <ul className="space-y-2">
              {selectedFolder.documents.map((doc) => (
                <li key={doc.id} className="flex justify-between items-start p-3 border rounded hover:bg-gray-50">
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    {doc.updatedBy && (
                      <div className="mt-2 text-xs text-gray-500 text-right">
                        ...
                        <p>le {doc.updatedAt ? formatDate(doc.updatedAt) : 'Date inconnue'}</p>
                      </div>
                    )}
                  </div>
                </li>
